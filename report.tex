...
The last dataset that we use was designed for the problem of the hate speech identification and classification, but we use the labels from the train and test set and merge them into one big dataset that we use for our analysis. It provides tags of \textit{hatespeech, profane, and slur}. It consists of \textcolor{red}{TODO} tweets, distribution of which can be seen in \textcolor{red}{TODO}.
...
\begin{tabular}{|l|l|}
\hline
category   & unigrams with highest tf-idf score \\ \hline
racism     & white, terror, coon                \\ \hline
sexism     & hot, hard, feminazi                \\ \hline
benevolent & nasty, sassy, classy               \\ \hline
abusive    & hoe, fake, love                    \\ \hline
hateful    & lgbt, religion, discrimination     \\ \hline

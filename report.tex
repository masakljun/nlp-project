...
\begin{figure*}[htb]\centering
	...
	\caption{\textbf{Word2Vec and Glove similar labels.} Left figure shows Word2Vec embeddings of neighboring words of labels we analyze and the right figure shows Glove embeddings. Note that we omit labels that are not in vocabulary.}
